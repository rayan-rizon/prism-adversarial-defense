...
On clean CIFAR-10 images, we observe $S(x) \sim \mathcal{N}(4.89, 1.38^2)$ 
...
\midrule
L1 & 0.10 & 6.81 & Log + normal inference \\
L2 & 0.03 & 8.05 & Input purification + inference \\
L3 & 0.005 & 9.64 & Expert routing (MoE) or reject \\
\bottomrule
\end{tabular}
\caption{Conformal detection tiers. Thresholds calibrated on $n{=}3000$ 
