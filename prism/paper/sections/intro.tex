...
using only a held-out clean calibration set. To our knowledge this is the
first activation-based adversarial-input detector to attach such a
distribution-free false-positive-rate certificate to its decision threshold.
